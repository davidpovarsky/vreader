...
| 47 | App crashes after navigating to search result or bookmark then tapping screen                         | Reader/*  | Critical | FIXED    | v5: Use layoutManager.addTemporaryAttribute instead of textStorage — accessibility callback infinite recursion caused EXC_BAD_ACCESS stack overflow |
