...
| 47 | App crashes after navigating to search result or bookmark then tapping screen                         | Reader/*  | Critical | FIXED    | v11: textStorage.setAttributedString() + clear selection + isReplacingText guard — bypasses attributedText setter's accessibility crash (0f8645f)    |
