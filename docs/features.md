...
| 13 | AI book/chapter summarization                                 | AI/*         | High     | TODO      | WI-D00 → WI-009 → WI-010 code committed. Unchecked on device. AI reads only title (bug #92)                                                                                      |
...
| 18 | AI-powered contextual translation with bilingual view         | AI/*         | High     | TODO      | WI-012 code committed. User: "Translate" opens Summarize panel instead (bug #95)                                                                                                 |
...
| 24 | Book source scraping (web novels)                             | BookSource/* | High     | TODO      | D01-D07 code committed. User: import shows success but sources not visible, search grey (bugs #100, #101)                                                                        |
