...
assert_contains "$WORKFLOW" 'run_feature_177_regression_tests:'
...
assert_contains "$WORKFLOW" 'Run targeted Feature 177 reader regressions'
assert_contains "$WORKFLOW" 'vreaderTests/TXTTextExtractorTests'
assert_contains "$WORKFLOW" 'vreaderTests/MDTextExtractorTests'
assert_contains "$WORKFLOW" 'vreaderTests/PDFReaderViewModelLocatorTests'
assert_contains "$WORKFLOW" 'vreaderTests/ReadiumEPUBNavigationMappingTests'
assert_contains "$WORKFLOW" 'vreaderTests/ReadiumEPUBHostTests'
assert_contains "$WORKFLOW" 'Feature177RegressionTests.xcresult'
