...
struct TXTChapterHighlightHelperTests {
    ...
    private static let chapters = [
        TXTChapter(title: "Chapter 1", globalStartUTF16: 0, textLengthUTF16: 100),
        TXTChapter(title: "Chapter 2", globalStartUTF16: 100, textLengthUTF16: 150),
        TXTChapter(title: "Chapter 3", globalStartUTF16: 250, textLengthUTF16: 150),
    ]
    ...
    func testZeroLengthChapter() {
        let chapters = [TXTChapter(title: "Empty", globalStartUTF16: 0, textLengthUTF16: 0)]
        let result = TXTChapterHighlightHelper.highlightsForChapter(
            chapterIndex: 0,
            chapters: chapters,
            persistedGlobalRanges: [NSRange(location: 0, length: 10)]
    ...
    func testNegativeGlobalStart() {
        let chapters = [TXTChapter(title: "Bad", globalStartUTF16: -1, textLengthUTF16: 100)]
        let result = TXTChapterHighlightHelper.highlightsForChapter(
            chapterIndex: 0,
            chapters: chapters,
            persistedGlobalRanges: [NSRange(location: 0, length: 10)]
